...
LORA_DEV_EUI = "PASTE_LAMP2_DEVEUI"          # 16 hex — unique to THIS lamp
LORA_APP_EUI = "0011223344556677"            # 16 hex — SAME on both lamps
LORA_APP_KEY = "PASTE_LAMP2_APPKEY"          # 32 hex — unique to THIS lamp
...
# messages. Join "lamp-cork" and the page opens by itself; if it
...
PORTAL_SSID      = "deLENIghted-2-Cork"   # max 32 characters
